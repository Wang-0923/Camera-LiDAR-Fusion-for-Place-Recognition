...
if __name__ == '__main__':
    ...
    parser.add_argument('--map_sequence', type=str, default=PROTOCOL1_MAP_SEQUENCE,
                        help='NCLT sequence used as database/map')
    parser.add_argument('--query_sequence', type=str, default=PROTOCOL1_QUERY_SEQUENCE,
                        help='NCLT sequence used as query')
    parser.add_argument('--split', type=str, default=PROTOCOL1_SPLIT, choices=['train', 'test', 'all'],
                        help='Spatial split used for map/query evaluation sets')
    parser.add_argument('--map_sampling_distance', type=float, default=PROTOCOL1_MAP_SAMPLING_DISTANCE,
                        help='Sampling distance for database/map scans')
    parser.add_argument('--query_sampling_distance', type=float, default=PROTOCOL1_QUERY_SAMPLING_DISTANCE,
                        help='Sampling distance for query scans')
    parser.add_argument('--dist_threshold', type=float, default=PROTOCOL1_DIST_THRESHOLD,
                        help='Filter queries without a map element within this radius')
    ...
    split = args.split
    map_sampling_distance = args.map_sampling_distance
    query_sampling_distance = args.query_sampling_distance
