...
class ModelParams:
    def __init__(self, model_params_path, dataset_type, dataset_folder):
        ...
        self.bev_fusion_use_deform_attn = params.getboolean('bev_fusion_use_deform_attn', True)
        ...
        self.vl_ablation_mode = params.get('vl_ablation_mode', 'fusion').lower()
        ...
        self.official_minkloc_root = params.get('official_minkloc_root', os.environ.get('MINKLOC_MULTIMODAL_ROOT'))
        self.minkloc_num_points = params.getint('minkloc_num_points', 4096)
        self.minkloc_quantization_size = params.getfloat('minkloc_quantization_size', 0.01)
        self.minkloc_image_cam = params.getint('minkloc_image_cam', 0)
        self.minkloc_normalize_pointcloud = params.getboolean('minkloc_normalize_pointcloud', True)
        self.minkloc_pointcloud_sample_seed = params.getint('minkloc_pointcloud_sample_seed', 17)
        self.official_adafusion_root = params.get('official_adafusion_root', os.environ.get('ADAFUSION_ROOT'))
        self.adafusion_image_cam = params.getint('adafusion_image_cam', 1)
        self.adafusion_voxel_shape = [int(e) for e in params.get('adafusion_voxel_shape', '72,72,48').split(',')]
        self.adafusion_image_size = [int(e) for e in params.get('adafusion_image_size', '300,400').split(',')]
        self.adafusion_fusion_method = params.get('adafusion_fusion_method', 'cat')
        self.adafusion_lp = params.getint('adafusion_lp', 1)
